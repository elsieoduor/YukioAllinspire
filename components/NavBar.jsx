...
const NavBar = () => {
  ...
  return (
    <nav className='flex-between w-full mb-16 pt-3'>
      ...
      <Image src='/assets/images/logo.svg' alt='YukioAllinspire' width={30} height={30} className='object-contain' />
      <p className='logo_text'>YukioAllinspire</p>
      </Link>
      ...
      <div className='sm:hidden flex relative'>
        {session?.user ? (
          <div className='flex'>
            ...
            width={30} height={30} className='object-contain'  onClick={()=>setToggle((prev)=> !prev)}/>
          ...
          {toggle && (
              <div className='dropdown'>
                ...
                <button type='button' onClick={()=> {setToggle(false); signOut();}} className='mt-5 w-full black_btn'> Sign Out</button>
